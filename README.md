...
4.  
Un digit de la tentative ne peut match qu'avec un seul digit du secret 
5.  
Un digit du secret ne peut match qu'avec un seul digit de la tentative 
6.  
Les matchs exacts sont prioritaires par rapport aux matchs partiels 
